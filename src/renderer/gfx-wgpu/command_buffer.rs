...
impl WgpuCommandBuffer {
    ...
    pub fn begin_render_pass(
        ...
        self.inner
            .begin_render_pass(render_pass, framebuffer, render_area, colors, depth, stencil);
...
mod tests {
    ...
    #[test]
    fn test_wgpu_cmd_buffer_new() {
        let cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        assert_eq!(cmd.get_type(), CommandBufferType::Primary);
    }

    #[test]
    fn test_wgpu_cmd_buffer_begin_end() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
    ...
    #[test]
    fn test_wgpu_cmd_buffer_render_pass() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
    ...
    #[test]
    fn test_wgpu_cmd_buffer_noop_methods() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
    ...
    #[test]
    fn test_wgpu_cmd_buffer_bind_pipeline() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
    ...
    #[test]
    fn test_wgpu_cmd_buffer_dispatch() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
        cmd.dispatch(&DispatchInfo::default());
        cmd.end();
    }

    #[test]
    fn test_wgpu_cmd_buffer_texture_ops() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
        cmd.blit_texture(1, 2, &[], Filter::Linear);
        cmd.copy_texture(1, 2, &[]);
        cmd.copy_texture_to_texture(1, 2, &[]);
        cmd.end();
    }

    #[test]
    fn test_wgpu_cmd_buffer_queries() {
        let mut cmd = WgpuCommandBuffer::new(CommandBufferInfo::default());
        cmd.begin();
        cmd.begin_query(1, 0);
        cmd.end_query(1, 0);
        cmd.reset_query_pool(1);
        cmd.end();
    }
}
