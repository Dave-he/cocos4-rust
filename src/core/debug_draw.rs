...
impl DebugDraw {
    ...
    pub fn draw_axes(&mut self, origin: Vec3, scale: f32, duration: f32) {
        self.draw_line(
            origin,
            Vec3::new(origin.x + scale, origin.y, origin.z),
            Color::new(255, 0, 0, 255),
            duration,
        );
        self.draw_line(
            origin,
            Vec3::new(origin.x, origin.y + scale, origin.z),
            Color::new(0, 255, 0, 255),
            duration,
        );
        self.draw_line(
            origin,
            Vec3::new(origin.x, origin.y, origin.z + scale),
